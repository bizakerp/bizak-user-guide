...
This page will later document the exact first-login experience for new Bizak users.

## Typical flow

1. Open the Bizak login page
2. Enter email and password
3. Select the organization or role if prompted
4. Land on the dashboard
5. Begin with the modules your role allows
